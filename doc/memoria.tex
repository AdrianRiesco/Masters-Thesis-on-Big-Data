...
\begin{abstract}
This project consists of the development of an \textbf{Extraction, Transformation and Loading} process to capture data from \textbf{Twitter} and \textbf{Spotify} APIs using software tools from the Big Data field, ensuring its scalability. Data from both sources have been combined, processed and stored in a Data Warehouse to be served to the user in a customized front-end. All services have been encapsulated in containers within the same network.
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Airflow, Apache, BigData, Bootstrap, Cassandra, Chart.js, Datatables, Docker, Docker Compose, ETL, Flask, Spark, Spotify, Twitter.
\end{abstract}
